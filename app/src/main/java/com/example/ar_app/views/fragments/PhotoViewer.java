...
public class PhotoViewer extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mainViewModel.photoUrl.observe(getViewLifecycleOwner(),new Observer<String>(){
            @Override
            public void onChanged(String s) {
                Glide.with(binding.photoView).asBitmap().load(mainViewModel.getPhotoUrl()).into(binding.photoView);
            }
        });
    }
}